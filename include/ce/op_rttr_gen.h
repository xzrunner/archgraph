...
#define PARM_FILEPATH_PARM ce/op/##PARM_OP_CLASS##.parm.h
#endif

#define RTTR_NAME ce::##PARM_OP_NAME

rttr::registration::class_<ce::op::PARM_OP_CLASS>(XSTR(RTTR_NAME))
.constructor<>()
#define PARM_FILEPATH XSTR(PARM_FILEPATH_PARM)
#define PARM_NODE_CLASS ce::op::##PARM_OP_CLASS
